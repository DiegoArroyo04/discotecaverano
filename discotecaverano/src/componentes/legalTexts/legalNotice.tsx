...
const LegalNotice: React.FC = () => {
    ...
    return (
        <div style={{ padding: "20px", fontFamily: "Montserrat, sans-serif" }}>
            <p className="titulo">Aviso Legal</p>

            <p className="subtitulos">1.Responsable del Tratamiento ¿Quién es el responsable del tratamiento de tus datos?</p>
            <p className="texto">Este sitio web es operado por Aurora Paradise. El acceso a este sitio web está condicionado a la aceptación de los términos y condiciones que se describen a continuación. Si continúa utilizando este sitio web, acepta todos los términos de uso.
            ...
            <p className="texto">5.1. La legitimación para el tratamiento de tus datos personales para la finalidad enumerada en el apartado 4.1 es el consentimiento expreso y libre prestado por usted al marcar la casilla “He leído y acepto la Política de Protección de Datos”, así como la ejecución de medidas precontractuales a solicitud del interesado, en caso de que en su consulta se interese por los productos y servicios ofrecidos por Aurora Paradise.</p>
            <p className="texto">5.2. La finalidad para el tratamiento de tus datos personales para la finalidad enumerada en el apartado 4.2 es el consentimiento expreso y libre prestado por usted a través de la casilla “Deseo recibir comunicaciones comerciales de productos y servicios ofrecidos por Aurora Paradise”</p>
            ...
            <p className="texto">7.1. Los datos se tratarán por el responsable del tratamiento, así como por los agentes y proveedores con los que Aurora Paradise contrate la prestación de algún servicio, en caso de que resulte necesario. Ello se hará siempre con contratos y garantías sujetos a los modelos aprobados por las autoridades en materia de protección de datos.</p>
            ...
            <p className="texto">También puedes acudir a nuestro Delegado de Protección de Datos a través de correo electrónico diegoarroyogonzalez04@gmail.com.</p>
            <p className="texto">Para el ejercicio de cualquiera de los derechos enunciados, puedes dirigir tu solicitud mediante escrito dirigido a Aurora Paradise en la dirección de correo electrónico diegoarroyogonzalez04@gmail.com, adjuntando copia de su DNI u otro documento oficial identificativo.</p>
