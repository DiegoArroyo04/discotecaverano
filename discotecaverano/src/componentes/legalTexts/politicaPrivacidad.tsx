...
const LegalNotice: React.FC = () => {
    ...
    return (
        <div style={{ padding: "20px", fontFamily: "Montserrat, sans-serif" }}>
            ...
            <p className="texto">1.1. Aurora Paradise, S.L., con CIF B55392039 y domicilio en domicilio en Calle Plaza Joel, 5, 1º F 13.230 - Membrilla (Ciudad Real). Contáctanos por el correo electrónico de atención al cliente diegoarroyogonzalez04@gmail.com.</p>
