...
const Cookies: React.FC = () => {
    ...
    return (
        <div style={{ padding: "20px", fontFamily: "Montserrat, sans-serif" }}>
            ...
            <p className="texto">- Las cookies propias: Son aquellas creadas o gestionadas por el responsable de la página web, en este caso, Aurora Paradise, y que se envían al equipo terminal del usuario desde un equipo o dominio gestionado por el propio editor y desde el que se presta el servicio solicitado por los usuarios. Utilizamos cookies propias persistentes con fines técnicos para controlar la visualización del banner informativo sobre cookies.</p>
            ...
            <p className="texto">El Responsable del tratamiento de sus datos de navegación, obtenidos a través de las cookies en nuestra página web es Aurora Paradise, S.L. Datos de contacto del responsable: Calle Antonio Plaza Joel, 5, 1º F, 13.230 - Membrilla (Ciudad Real). Datos de contacto del Delegado de Protección de Datos: diegoarroyogonzalez04@gmail.com</p>
            ...
            <p className="texto">Como titular de los datos usted tiene derecho a acceder, actualizar, rectificar y suprimir los datos, así como otros derechos, o solicitar más información sobre el tratamiento que realizamos de las cookies dirigiéndose al correo electrónico diegoarroyogonzalez04@gmail.com Tiene derecho a presentar cualquier reclamación ante la autoridad de control competente, considerando que la misma es, en España, la Agencia Española de Protección de Datos. Para poder ejercitar sus derechos en materia de protección de datos puede contactarnos a través de correo electrónico diegoarroyogonzalez04@gmail.com.</p>

            <p className="subtitulos">Actualizaciones y cambios en la Política de Cookies</p>
            <p className="texto">Aurora Paradise realizará una revisión de la Política de cookies anualmente, salvo que existan exigencias normativas o de otra índole que hagan necesario adaptar la Política con una periodicidad inferior. Por tanto, se aconseja a los usuarios que consulten periódicamente su contenido, con el objetivo de estar informado adecuadamente sobre cómo y para qué utilizamos las cookies. Fecha de la última actualización: Junio de 2024.</p>
